...
<div id="main" class="container">
    <div class="row wrapper">
        <div id="book-appointment-wizard" class="col-12 col-lg-10 col-xl-8">
            ...
            <h1>Modo desarrollo activado</h1>
                        ...
                        <div class="col-12 col-md-6">
                            <div id="select-time">
                                <div class="form-group">
                                    ...
                                    <?= render_timezone_dropdown('id="select-timezone" class="form-control" selected="true" value="UTC"'); ?>
                                </div>
            ...
            <div id="frame-footer">
                <small>
                    <span class="footer-powered-by">
                        ...
                        <a href="https://proderi.com" target="_blank">Proderi</a>
                    </span>
