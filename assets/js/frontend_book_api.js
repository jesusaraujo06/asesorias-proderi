...
(function (exports) {
    ...
    exports.registerAppointment = function () {
        ...
        var arrayForPowerAutomate = {};

        const getConsultorEmail = new Promise((resolve, reject) => {
            let email;
            $.ajax({
                url: `http://localhost:81/asesorias-proderi/index.php/api/v1/providers/${formData.appointment.id_users_provider}`,
                method: 'get',
                headers: {
                    Authorization: "Bearer proderi2022"
                },
                dataType: 'json',
            })
            .done(function (response) {
        ...
        getConsultorEmail.then(res => {
            arrayForPowerAutomate["start_datetime"]     = formData.appointment.start_datetime;
            arrayForPowerAutomate["end_datetime"]       = formData.appointment.end_datetime;
            arrayForPowerAutomate["email_customer"]     = formData.customer.email;
            arrayForPowerAutomate["email_consultor"]    = res;

            const jsonArray = JSON.stringify(arrayForPowerAutomate);
            ...
            $.ajax({
                method: 'POST',
                url: `https://prod-30.brazilsouth.logic.azure.com:443/workflows/6f6a2e8ea8bd43d2bbd69b2efbc7094a/triggers/manual/paths/invoke?api-version=2016-06-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=45z_WDNfctUvef3Idm9m2iLv5jKK19Wjc7DenS5UkFM`,
                data: jsonArray,
